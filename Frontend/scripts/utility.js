...
function getStocksInPortfolio(filter) {
    return myPortfolio.getStocksByFilter(filter);
}
...
function getETFsInPortfolio(filter) {
    return myPortfolio.getETFsByFilter(filter);
}
